---
description: >-
  Prontera mới được cải tạo giờ đây ẩn chứa một bí mật đen tối sau sự sụp đổ của
  nó. Giải mã bí ẩn này bằng cách tham gia vào cuộc xâm nhập này.
---
...
*   Một số vật phẩm có thể được thu thập bằng cách đánh bại <mark style="color:red;">**\[QUÁI VẬT ĐẶC BIỆT**</mark>**]**.
    ...
    <figure><img src="../.gitbook/assets/00095445.gif" alt=""><figcaption><p><mark style="color:red;"><strong>Giao tiếp với NPC "CRAFTS"</strong></mark></p></figcaption></figure>
{% endtab %}
...
*   Sau khi các linh hồn được giải phóng, anh ta sẽ mở rào cản đến <mark style="color:red;">**SATAN MORROC**</mark>.
    ...
    <figure><img src="../.gitbook/assets/21233333.png" alt=""><figcaption><p><mark style="color:red;"><strong>Sau khi hoàn thành tất cả các thử thách, bạn phải nói chuyện với anh ta để mở khóa thử thách cuối cùng: đánh bại Satan Morroc.</strong></mark></p></figcaption></figure>
{% endtab %}
...
| Sprite                                      | Mô tả                          |
| ------------------------------------------- | ------------------------------ |
| ![](../.gitbook/assets/0002220.png)         | Boss của Phần Một của Instance |
